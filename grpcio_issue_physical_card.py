...
open_credit_account_request = OpenCreditCardAccountRequest(
    user_id=create_user_response.user.id
)
open_credit_account_response: OpenCreditCardAccountResponse = (
    accounts_gateway_service.OpenCreditCardAccount(open_credit_account_request)
)
print('Open credit card account:', open_credit_account_response)

issue_physical_card_request = IssuePhysicalCardRequest(
    user_id=create_user_response.user.id,
    account_id=open_credit_account_response.account.id
)
...
print('Issue physical card:', issue_physical_card_response)