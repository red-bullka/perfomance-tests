...
class Fake:
    ...
    def proto_enum(self, value: EnumTypeWrapper) -> int:
        ...
        :param value: Proto enum (EnumTypeWrapper), например OperationStatus.
        :return: int — одно из значений перечисления.
        """
        return self.faker.random_element(list(value.values()))
