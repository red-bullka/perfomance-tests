...
users_gateway = UsersGatewayServiceStub(channel)
accounts_gateway = AccountsGatewayServiceStub(channel)
...
open_debit_card_account_response: OpenDebitCardAccountResponse = accounts_gateway.OpenDebitCardAccount(
