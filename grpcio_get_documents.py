...
print('Open savings account:', open_savings_account_response)
...
print('Get tariff_document response:', get_tariff_document_response)
...
print('Get contract document response:', get_tariff_document_response)